    ...
    div [ class "min-h-screen py-4 font-quicksand", style "background-color" "#1E1E1E" ]
        [ div [ class "max-w-7xl mx-auto mt-10" ]
            ...
            , div [ class "grid grid-cols-1 lg:grid-cols-2 gap-10 justify-between" ]
                [ viewImage
                , div [ class "space-y-8" ]
                    [ cardSection "Work" [ "Building CLI tools", "VS Code extension development", "Language design work", "Website development", "UI/UX design in Figma" ]
                    , cardSection "Open Source" [ "Looking to contribute to open source projects" ]
                    , cardSection "Personal Projects" [ "Currently having fun building this website", "Design experiments" ]
                    ]
                ]
            ]
        , viewCLIButton
